...
public class Responsable {
    ...
    public Responsable(int codigoResponsableTurno, String nombreResponsable, String apellidosResponsable, String telefonoPersonal, int codigoArea, int codigoCargo) {
